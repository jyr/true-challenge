# Generated by Django 3.0.1 on 2019-12-22 01:31
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('type', models.CharField(choices=[('facade', 'Facade'), ('interior', 'Interior'), ('baths', 'Bathrooms'), ('beds', 'Bedrooms'), ('kitchen', 'kitchen')], max_length=30, verbose_name='Photo Type')),
        ...
        migrations.AddField(
            model_name='listing',
            name='location',
            field=models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='listings.Location', verbose_name='Location'),
        ),
    ]
